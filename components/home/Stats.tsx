    ...
    <section className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.h2
            variants={item}
            className="text-3xl sm:text-4xl font-extrabold text-slate-900 text-center"
          >
            We Are Your <span className="text-blue-400">Digital Partner for Growth</span>
          </motion.h2>

          <motion.p variants={item} className="mt-4 text-lg text-slate-800 max-w-2xl mx-auto text-center">
