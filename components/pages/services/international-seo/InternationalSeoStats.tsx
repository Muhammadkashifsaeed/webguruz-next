...
const stats = [
  ...
  { value: 40, suffix: "%", label: "Average Increase in Qualified leads" },
  { value: 200, suffix: "%", label: "Increase in ROI" },
];

export default function InternationalSeoStats() {
  return (
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900">
          Make Your Presence Felt Globally with{" "}
          <span className="text-blue-500">International SEO</span>
        </h2>

        <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-700">
          International SEO ensures that your business can be found by potential customers worldwide, driving brand awareness, increasing traffic, and enhancing revenue opportunities across
        </p>
