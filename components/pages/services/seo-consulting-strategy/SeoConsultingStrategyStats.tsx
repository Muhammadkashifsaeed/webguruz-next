...
const stats = [
  { value: 500, suffix: "+", label: "Successful projects across industries." },
  { value: 1800, suffix: "+", label: "Clients globally trust our services" },
  { value: 50, suffix: "+", label: "Certified SEO experts on our team" },
    ...
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900">
          <span className="text-blue-500">SEO Strategies</span> Driven By Results
        </h2>
