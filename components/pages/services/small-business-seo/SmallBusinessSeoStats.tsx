...
const stats = [
  ...
  { value: 50, suffix: "+", label: "Skilled SEO experts" },
  { value: 17, suffix: "+", label: "Years of Experience" },
];

export default function SmallBusinessSeoStats() {
  return (
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900">
          <span className="text-blue-500">Your SEO Partner</span> for Success
        </h2>

        <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-700">
          What WebGuruz Brings to Your Small Business
        </p>
